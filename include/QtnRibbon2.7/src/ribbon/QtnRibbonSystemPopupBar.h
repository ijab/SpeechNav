...
namespace Qtitan
{
    ...
    class QTITAN_EXPORT RibbonPageSystemPopupBarListCaption : public QWidget
    {
        Q_OBJECT
    public:
        RibbonPageSystemPopupBarListCaption(const QString& caption);
        virtual ~RibbonPageSystemPopupBarListCaption();
    ...
    private:
        ...
        Q_DISABLE_COPY(RibbonPageSystemPopupBarListCaption)
    };

    class RibbonPageSystemRecentFileListPrivate;
    /* RibbonSystemRecentFileList */
    class QTITAN_EXPORT RibbonPageSystemRecentFileList : public RibbonPageSystemPopupBarListCaption
    {
        Q_OBJECT
    public:
