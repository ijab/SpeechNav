...
namespace Qtitan
{
    ...
    public:
        ...
        void setSizeHint(const QSize& szItem);
        QIcon icon() const;
    ...
    public:
        RibbonGalleryItem* addItem(int image, const QPixmap& pixmap, const QSize& sizeImage, QColor clrTransparent = QColor());
        RibbonGalleryItem* addItem(RibbonGalleryItem* item, const QString& caption = QString(), const QIcon& icon = QIcon());
        RibbonGalleryItem* insertItem(int index, RibbonGalleryItem* item, const QString& caption = QString(), const QIcon& icon = QIcon());

        RibbonGalleryItem* addLabel(const QString& caption);

        void clear();
        void remove(int index);

        void setSize(const QSize& szItem);
        QSize getSize() const;
    ...
    public:
        ...
        OfficePopupMenu* getPopupMenu() const;

    public:
        int getItemCount() const;

        RibbonGalleryItem* getItem(int nIndex) const;
        ...
        RibbonGalleryItem* getCheckedItem() const;
    ...
    public:
        ...
        QRect getItemDrawRect(int index);
