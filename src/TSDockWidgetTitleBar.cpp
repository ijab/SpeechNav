...
TSDockWidgetTitleBar::TSDockWidgetTitleBar(QDockWidget* dockWidget)
        : QWidget(dockWidget), d(new TSDockWidgetTitleBarPrivate(this))
{
    QDockWidget *q = dockWidget;

    d->floatButton = new TSDockWidgetTitleBarButton(this);
    ...
    d->closeButton = new TSDockWidgetTitleBarButton(this);
    ...
    d->collapseButton = new TSDockWidgetTitleBarButton(this);
...
TSDockWidgetTitleBar::~TSDockWidgetTitleBar()
{
    delete d;
}

QSize TSDockWidgetTitleBar::minimumSizeHint() const
{
    return sizeHint();
}

QSize TSDockWidgetTitleBar::sizeHint() const
{
...
void TSDockWidgetTitleBar::paintEvent(QPaintEvent*)
{
...
void TSDockWidgetTitleBar::resizeEvent(QResizeEvent*)
{
    QDockWidget *q = qobject_cast<QDockWidget*>(parentWidget());
    int fw = q->isFloating() ? q->style()->pixelMetric(QStyle::PM_DockWidgetFrameWidth, 0, q) : 0;
...
void TSDockWidgetTitleBar::setCollapsed(bool collapsed)
{
    QDockWidget *q = qobject_cast<QDockWidget*>(parentWidget());
...
void TSDockWidgetTitleBar::setCollapsable(bool collapsable)
{
    d->collapseButton->setVisible(collapsable);
}

void TSDockWidgetTitleBar::setTextVisible(bool visible)
{
    d->textVisible = visible;
}

void TSDockWidgetTitleBar::setIgnoreTextSize(bool ignore)
{
...
/*
 *  TSDockWidgetTitleBarPrivate
 */
TSDockWidgetTitleBarPrivate::TSDockWidgetTitleBarPrivate(TSDockWidgetTitleBar* thePublic) : thePublic(thePublic),
    ...
    {
        if (openIcon.isNull())
            openIcon = QIcon(QLatin1String(":/Resources/ribbonMaximize.png"));
        if (closeIcon.isNull())
            closeIcon = QIcon(QLatin1String(":/Resources/ribbonMinimize.png"));
    }

void TSDockWidgetTitleBarPrivate::toggleFloating()
{
...
void TSDockWidgetTitleBarPrivate::toggleCollapsed()
{
    QDockWidget *q = qobject_cast<QDockWidget*>(thePublic->parentWidget());
...
void TSDockWidgetTitleBarPrivate::featuresChanged(QDockWidget::DockWidgetFeatures)
{
    QDockWidget *q = qobject_cast<QDockWidget*>(thePublic->parentWidget());
